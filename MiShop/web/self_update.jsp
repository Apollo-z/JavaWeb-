        ...
        <div class="rtcont fr">
            ...
            <c:if test="${!empty user}">
                <form action="updateUser" method="get">
                    <div class="subgrzl ml40"><span>ID号</span>
                        <input style="width: 200px;height: 30px;" type="text" name="id" value="${user.id}" readonly="readonly">
                    </div>

                    <div class="subgrzl ml40"><span>昵称</span>
                        <input style="width: 200px;height: 30px;" type="text" name="name" placeholder="请输入新的用户名">
                    </div>

                    <div class="subgrzl ml40">
                        <span>手机号</span>
                        <input style="width: 200px;height: 30px;" type="text" name="telephone" placeholder="请输入联系电话">
                    </div>

                    <div class="subgrzl ml40">
                        <span>密码</span>
                        <input style="width: 200px;height: 30px;" type="password" name="password" placeholder="请输入登录密码">
                    </div>

                    <div class="subgrzl ml40">
                        <span>个性签名</span>
                        <input style="width: 200px;height: 30px;" type="text" name="gexing" placeholder="请输入个性签名">
                    </div>

                    <div class="subgrzl ml40">
                        <span>我的爱好</span>
                        <input style="width: 200px;height: 30px;" type="text" name="hobby" placeholder="请输入您的爱好">
                    </div>

                    <div class="subgrzl ml40">
                        <span>收货地址</span>
                        <input style="width: 200px;height: 30px;" type="text" name="address" placeholder="请输入您的新住址">
                    </div>

                        <center>
                            <input style="
                            width: 90px;height: 40px;background-color: orangered;color: whitesmoke;
                            font-weight: bolder;border-radius: 10px;cursor: pointer;
                            " type="submit" value="确认修改">

                            <span>
                                 <a style="color: blue" href="./self_info.jsp">点击返回</a>
                            </span>
                        </center>
                </form>
            </c:if>

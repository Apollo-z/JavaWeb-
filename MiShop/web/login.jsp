...
<head>
    ...
    <script>
        ...
        function getCode() {
            var codeStr = 'abcdefghijklmnopqrstuvwxyzABCDEFGHJKLMNOPQRSTUVWXYZ023456789';
        ...
        function check() {
            ...
            var oDiv = document.getElementById('code');
            if (va.toLowerCase() == oDiv.value.toLowerCase()) {
...
<div class="w3layouts-two-grids">
    ...
    <div class="mid-class">
        ...
        <div class="txt-left-side">
            <h1 class="text-center" style="font-weight: bold;font-size: 1.5em ;margin-top: 30px">欢迎来到登录界面</h1>
            <form id="login" role="form" class="form-horizontal">
                <div class="form-group" style="padding-top:50px">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" placeholder="请输入您的账号" id="name" name="name"
                               style="height: 40px"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-md-6">
                        <button type="submit" class="btn btn-primary" style="height: 40px; margin-top: 15px">立即登录</button>
                    </div>
                </div>

            </form>
            <div class="w3layouts_more-buttn">
                <h3 style="padding-top: 15px">还没有账号？
                    <a href="register.jsp">立即注册
                    </a>
                </h3>
            </div>
        </div>

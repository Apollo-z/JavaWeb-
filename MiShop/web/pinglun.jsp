...
<%--pinglun start--%>
    ...
    <%--<br>--%>
    <center>
        <h2 id="tab1" class="selected" name="tab" style="font-weight: 900;">【用  户  评  论】</h2>
    </center>
    <br>
    ...
    <table border="1" cellspacing="0">
        ...
        <c:forEach items="${comments}" var="comment" varStatus="vs">
            ...
            <tr>
                ...
                <td>
                        <%--产品打分--%>
                        <font style="color: red;font-weight: bolder">${comment.score}</font>
                </td>
            </tr>
        </c:forEach>
        ...
        <tr>
            <td colspan="6">
                ...
                <font style="color: red;font-weight: bolder">还在等什么，快来下单吧！</font>
            </td>
        </tr>
    </table>
    </c:if>
    ...
    <%--如果评论对象为空的话，就显示暂未有评论--%>
    <c:if test="${empty comments}">
        <center style="color: darkgray;font-size: 30px">暂未有任何评论记录！快来下单，成为第一个评论用户吧！</center>
    </c:if>

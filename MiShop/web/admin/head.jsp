				...
				<c:if test="${!empty adminList}">
					...
					<div class="collapse navbar-collapse pull-right"
						...
						<ul class="nav navbar-nav">
							<li>
								<!-- 右上 -->
								<a class="dropdown-toggle" onclick="logout()" style="height: 50px">
									<span style="cursor: pointer" class="pull-left nav-username">退出</span>
								</a>
							</li>
						</ul>
					</div>
						...
						<ul class="nav navbar-nav">
							<li>
								...
								<a class="dropdown-toggle" data-toggle="dropdown" href="#"
									...
									<span class="pull-left nav-username">管理员-${adminList.adminname }</span>
								</a>
	...
	<script type="text/javascript">
		...
		function logout(){
			...
			if (confirm("是否确定要退出登录？")){
				window.location.href= "${APP_PATH }/adminLogout";
			}

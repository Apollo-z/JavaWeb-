...
<div class="banner_x center">
    ...
    <div class="nav fl">
        <ul>
            <li><a href="search?cid=1">小米手机</a></li>
            <li><a href="search?cid=2">红米</a></li>
            <li><a href="search?cid=3">平板</a></li>
            <li><a href="search?cid=4">电视</a></li>
            <li><a href="search?cid=5">盒子</a></li>
            <li><a href="search?cid=6">路由器</a></li>
            <li><a href="search?cid=8">智能硬件</a></li>
            <li><a href="">服务</a></li>
            <li><a href="">社区</a></li>
        </ul>
    </div>
...
<div>
    ...
    <table border="1" cellspacing="0">
        ...
        <tr>
            <td colspan="6">
                    <%--这里不变--%>
                <font style="color: darkolivegreen;font-weight: bolder">合计：</font><font style="color: red;font-weight: bolder">${totalMoney}元</font>
            </td>
        </tr>
    </table>
...
<!-- self_info -->
        ...
        <center>
            <div style="width: 60px;display: inline-block;margin-right: 70px">
                <button class="ant-btn ant-btn-red" onclick="toAlipay(${totalMoney})">支付宝支付</button>
            </div>

            <div style="width: 60px;display: inline-block;margin-left: 70px">
                <button class="ant-btn ant-btn-red" id="fakePay" onclick="fakePay(${totalMoney})">模拟支付</button>
            </div>
        </center>
...
<script>
    ...
    //支付宝支付
    function toAlipay(money) {
        //获取订单号
        var msoid_pay = $("#msoid_span").text();
        //获取总金额
        window.location.href = "userAlipayPage.jsp?userpay_msoid=" + msoid_pay + "&userpay_money=" + money;
    }
